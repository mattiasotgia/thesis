\chapter{The track/shower classification BDT in the Pandora reconstruction}
...
% Machine learning algorithms, such as the BDT implemented for track and electromagnetic shower classification presented in this appendix, require two ``phases'': a first mainly ``offline'' phase where the network is trained, i.e., learns how to perform the node cuts using both the 
