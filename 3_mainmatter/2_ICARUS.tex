...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, trim={0 9.5cm 0 9.5cm}, clip]{thesis/6_figures/detector/wire_orientation.pdf}
...
\begin{figure}
    \centering
    \subfloat[]{\includegraphics[height=5.5cm]{thesis/6_figures/detector/TPC_wires_texts.pdf}\label{fig:ICARUS_wires}}
    \hspace{1em}
    \subfloat[]{\includegraphics[height=5.5cm, trim={8cm 2cm 8cm 2cm}, clip]{thesis/6_figures/detector/TPC_inner.pdf}\label{fig:ICARUS_PMTs_cage}}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{thesis/6_figures/beams/cumulative_official_runs.pdf}
