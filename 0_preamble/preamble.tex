...
\usepackage[bottom=3.5cm, inner=3.5cm,outer=4cm, marginpar=3.5cm, includeheadfoot]{geometry} % NEL CASO a4paper
...
\newcommand{\cheated}{%
\tikz[scale=0.23] {
    \draw[fill=Red, line width=0.5, line cap=round] (0,0) rectangle (1, .8);
}}

\newcommand{\nominal}{%
\tikz[scale=0.23] {
    \draw[fill=Gray, line width=0.5, line cap=round] (0,0) rectangle (1, .8);
}}